						...
						<div class="form-group" class="row">
							...
							<div class="col-sm-4">
								...
								<form:select id="clientes" class="form-control"
									modelAttribute="venda" placeholder="Clientes" path="cliente"
									required="true">
						...
						<div class="form-group" class="row">
							...
							<div class="col-sm-4">
								<form:select id="produtos" class="form-control"
									modelAttribute="produtoLista" path="produtos" required="true">
						...
						<div class="form-group" class="row">
							...
							<div class="col-md-4">
								<input id="textinput" name="valorVenda" type="double"
									placeholder="ex: 200.50" class="form-control input-md"
									required="">
